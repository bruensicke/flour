 ...
 * First, it loads defaults at
 * 
 *   FLOUR/config/geshi.php
 * 
 * Second, it loads app settings via
 * 
 ...
 **/
	...
	{
		if (file_exists(FLOUR.'/config/geshi.php')) {
			include FLOUR.'/config/geshi.php';
		}
