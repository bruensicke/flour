...
class EscapeComponent extends Object {
	 ...
	 * initialize
	 *
	 * @param Controller $controller Calling Controller
	 * @param array $settings Array of Settings passed into Component
	 * @return void
	 * @access public
	 */
	 ...
	 * @access public
	 */
	public function _h($text, $charset = null) {
		if (is_array($text)) {
